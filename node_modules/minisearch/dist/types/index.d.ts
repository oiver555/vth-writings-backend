...
declare type Kind<T> = keyof Iterators<T>;
declare type Result<T, K extends keyof Iterators<T>> = Iterators<T>[K];
...
declare type FuzzyResults<T> = Map<string, FuzzyResult<T>>;
...
declare type DocumentTermFreqs = Map<number, number>;
declare type FieldTermData = Map<number, DocumentTermFreqs>;
/**
